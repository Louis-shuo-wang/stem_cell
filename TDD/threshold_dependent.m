...
lambdaPs = [1.0855, 1.08938, 1.09192, 1.09426, 1.09646];
lambdaRs = [0.01, 0.03, 0.05, 0.07, 0.09];
p1s = [0.5, 0.5, 0.5, 0.5, 0.5];
k1s = [0.000039, 0.0000655386, 0.0000839782, 0.0000986415, 0.000111029]/params.dx;
...
saveas(f1, 'ratio_TDD', 'fig');
saveas(f1, 'ratio_TDD', 'svg');
...
saveas(f2, 'damage_S_TDD', 'fig');
saveas(f2, 'damage_S_TDD', 'svg');
...
saveas(f3, 'damage_T_TDD', 'fig');
saveas(f3, 'damage_T_TDD', 'svg');